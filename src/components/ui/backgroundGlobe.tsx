  ...
  return (
    <div className="relative flex items-center justify-center h-screen">
      ...
      <motion.div
        ...
        <h2 className="text-xl md:text-4xl font-bold">해외시장 개척의 파트너 LoGO</h2>
        <p className="text-base md:text-lg font-normal max-w-md mt-2 mx-auto">Launch With LoGO</p>
