...
const EditPost = () => {
    ...
    useEffect(() => {
        ...
        apiFetch(`${apiUrl}/retriever/community/load/${community_id}`,
            ...
            .then(response => {
                ...
                const community = response.data.result.community;
                setTitle(community.title);
                setContent(community.content);
                setQnaEmail(community.email);
                setExistingImages(response.data.result.community_images || []);
            })
    ...
    const handleSubmit = (e) => {
        ...
        apiFetch(`${apiUrl}/retriever/community/edit`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${token}`
            },
